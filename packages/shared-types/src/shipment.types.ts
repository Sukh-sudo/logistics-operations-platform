...
export interface CreateShipmentDto { shipmentNumber: string; referenceNumber?: string; notificationRecipient?: string; originTerminalId: number; destinationTerminalId: number; transitDays: number; packageTrackingNumbers: string[]; }
...
export interface ShipmentDetailDto { id: string; shipmentNumber: string; referenceNumber: string | null; status: string; originTerminalId: number; destinationTerminalId: number; transitDays: number | null; estimatedDeliveryAt: string | null; createdAt: string; updatedAt: string; originTerminal: TerminalDto; destinationTerminal: TerminalDto; snapshot: ShipmentSnapshotDto | null; packages: Array<{ shipmentId: string; packageId: string; assignedAt: string; package: PackageSnapshotDto }>; }
